...
def home():
    """Basic home route"""
    return jsonify({
        'message': 'Investment Performance Tool v2 - Global Investment Performance API with Morningstar is running',
        'status': 'live',
...
if __name__ == '__main__':
    ...
    print("Starting Investment Performance Tool v2 - Global Morningstar API server...")
